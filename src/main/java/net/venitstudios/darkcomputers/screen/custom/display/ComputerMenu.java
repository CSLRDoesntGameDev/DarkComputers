...
public class ComputerMenu extends AbstractContainerMenu  {
    ...
    public ComputerMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public ComputerMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.COMPUTER_DISPLAY_MENU.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.COMPUTER_BLOCK.get());
    }
}
